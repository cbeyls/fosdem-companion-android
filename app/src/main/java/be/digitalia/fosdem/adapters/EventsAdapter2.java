...
public class EventsAdapter2 extends PagedListAdapter<StatusEvent, EventsAdapter2.ViewHolder>
	...
	public EventsAdapter2(Context context, LifecycleOwner owner) {
		this(context, owner, true);
	}

	public EventsAdapter2(Context context, LifecycleOwner owner, boolean showDay) {
		super(DIFF_CALLBACK);
