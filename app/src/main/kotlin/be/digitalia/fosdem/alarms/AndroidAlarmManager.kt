...
class AndroidAlarmManager(
    ...
    override suspend fun onScheduleRefreshed() {
        if (isNotificationsEnabled()) {
            updateAlarms()
        }
    }

    override suspend fun onBookmarksAdded(alarmInfos: List<AlarmInfo>) {
    ...
    override suspend fun onBookmarksRemoved(eventIds: LongArray) {
